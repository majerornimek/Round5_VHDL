...
HD_PWD='C:/Users/ma/Documents/GitHub/Round5_VHDL/Xilinx/Round5_VHDL/Round5_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Round5_enc_arith.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Round5_enc_arith.tcl
